...
import { InputLabel, Tooltip, Checkbox, Modal, Box, IconButton, Typography, Button } from '@mui/material';
import { showSuccessToast, showErrorToast } from '../../../Utils/Notification';
import { XCircle, FolderOpen, Export } from 'phosphor-react';
...
const Encomenda = ({ invalidFields, formData, onDataChange, screenValidation }) => {
  ...
  useEffect(() => {
    onDataChange({ ...formData, 'tipoComunicacao': 2 });
